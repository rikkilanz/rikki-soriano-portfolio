...
export default function ContactPage() {
  return (
    <section className="p-8 text-papayawhip">
      ...
      <h2 className="font-bold text-[2.6vw] leading-[1]">
      ...
      <ul className="flex flex-wrap mt-2 gap-8">
        <li className="p-4 bg-papayawhip rounded-md flex items-center gap-2 font-md text-black">
          {/* GitHub Icon */}
          <div>
            <svg
            ...
            {/* <p className="text-center font-bold mt-2">GitHub</p> */}
          </div>
          {/* Add hover effect that pops this out lol */}
          {/* <p>Yes I can code and it's my living.</p> */}
        </li>
        <li className="p-4 bg-papayawhip rounded-md flex items-center gap-2 font-md text-black">
          {/* GitHub Icon */}
          <div>
