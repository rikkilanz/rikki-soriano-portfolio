...
<body>
    ...
    <main>
        ...
        <section class="project">
            ...
            <img class="project-thumbnail" src="<?php echo get_public_url('images/')?>rikki-soriano-fizzy-pop-thumb.jpg" alt="A mobile mock of klin klothing's UI prototype" data-lightbox="rikki-soriano-fizzy-pop-thumb">
